...
- App chính hiện có authenticated shell với Home, Groups, Activity và Settings placeholder.
- Phase hiện tại: chuẩn bị sang `Phase 5 - Groups`.

## Hướng phát triển tiếp theo

Sau khi chốt main layout ở Phase 4, bước tiếp theo là làm `Phase 5 - Groups`: đọc contract Group, tạo models/API/state và thay placeholder Groups bằng danh sách nhóm thật.
